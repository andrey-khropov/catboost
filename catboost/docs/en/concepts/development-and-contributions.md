...
- CLI
  ...
  1. Set the following environment variables:
      ...
      Before revision [a087975](https://github.com/catboost/catboost/commit/a087975944e63779e060502beba21d6203615446), it was necessary to additionally set `CMAKE_SOURCE_DIR` to the root of the local copy of the {{ product }} repository.
